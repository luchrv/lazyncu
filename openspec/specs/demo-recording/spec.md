...
## Purpose
Reproducible demo capture for the README: VHS tapes render the GIFs from synthetic fixtures in an isolated environment, so demos regenerate identically after UI changes and never leak personal configuration or paths.
